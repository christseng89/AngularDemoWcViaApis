...
> [!info] 2026-08-30 更新
> 本页原先的 8 端点清单是历史快照。现行微服务 OAS v1.37.0 共 22 operations，并包含 compound submit/release、edit 与 withdraw-maker-submit；实现与 OAS 路由对照无缺口。完整表面以 `analysis/balance-component-api.yaml` 为准。
