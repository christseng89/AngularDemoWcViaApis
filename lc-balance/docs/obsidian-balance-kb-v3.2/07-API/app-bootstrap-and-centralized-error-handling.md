...
Angular presenter 保留 HTTP status／code：400／422 显示可安全呈现的业务验证原因，401／403／404 与其他 4xx 使用明确分类，5xx／network 维持 service-unavailable 分类。本地表单验证独立显示，不使用 `BAL-UI-UNEXPECTED`。
