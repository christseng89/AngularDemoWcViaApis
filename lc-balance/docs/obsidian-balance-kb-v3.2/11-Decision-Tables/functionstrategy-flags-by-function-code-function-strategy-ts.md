...
| B5   | false                        | SETTLE                      | null                 | [plain]                                                              | false                           | false                  | false                           | false           | true                       |
...
| A3S、B4            | `CANCEL`                | strategy 定义的 sibling ids，最后 primary | 回到该 Function 的 Transaction Index            |
| B5                 | `CANCEL`                | primary movement                          | 回到 B5 Transaction Index                       |
