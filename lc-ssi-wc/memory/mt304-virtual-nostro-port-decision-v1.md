...
**Related baseline:** `memory/swift-mt347-v2.md`  
...
- `memory/swift-mt347-v2.md` sections 4 and 7;
- `memory/lc-ssi-wc-operating-model-zh-v2.md`;
- `memory/ssi-resolver-service-boundary-v1.md`;
