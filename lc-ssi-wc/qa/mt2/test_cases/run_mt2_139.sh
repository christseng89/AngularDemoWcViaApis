...
WORKBOOK="${MT2_QA_WORKBOOK:-$WORKSPACE/qa/mt2/mt2-final/fixtures/MT2XX_測試案例_SSI與NOSTRO_v6.2_FINAL.xlsx}"
ENDPOINTS="${MT2_QA_ENDPOINTS:-$WORKSPACE/qa/mt2/mt2-final/case-endpoints.json}"
REGISTRY="${MT2_QA_REGISTRY:-$WORKSPACE/qa/mt2/mt2-final/message-adapter-registry.json}"
BANK_SERVICES="${MT2_QA_BANK_SERVICES:-$WORKSPACE/qa/mt2/mt2-final/fixtures/baselines/bank-service.current.json}"
OUTPUT="${MT2_QA_REPORT:-$WORKSPACE/qa/mt2/reports/mt2-139-curl-results.json}"
