...
The TypeScript publisher, API dry-run and tests are maintained under
`qa/FIX_DATA/src/rma/reload-test-data/`; this directory contains the governed
RMA data artifacts and publication evidence.
...
python scripts/rebuild-demo-database.py export \
  ...
  --source-label qa/FIX_DATA/rma/reload-test-data/ssi-demo.v15.8.pacs009-repaired-isolated.sqlite
