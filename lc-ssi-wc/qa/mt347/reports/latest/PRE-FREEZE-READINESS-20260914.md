...
| MT2 v15.3 data-quality protection | **FAIL**    | `npm run qa:mt2:v153:data-quality`：預期 HTTP 409，實際 HTTP 200；見 `qa/mt2/reports/MT2XX_v15.3_browser_DATA_QUALITY_409_20260912.json` |
...
- `qa/mt347/reports/latest/CHANGE-REQUEST-MT347-UI-SEQUENCE-COVERAGE-20260913.md` 與 `JOINT-BA-QA-MT347-FINAL-REPORT-20260912.md` 仍引用 TDD v5、169/41 owner split，屬歷史受控證據；目前 v6 audit 為 168/42。正式封版前需由 BA/QA 發布 v6 一致的更新報告，不應直接改寫歷史結論。
