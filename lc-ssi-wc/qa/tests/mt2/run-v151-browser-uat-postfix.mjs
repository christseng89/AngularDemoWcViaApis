...
const PORTAL_URL = process.env.PORTAL_URL ?? "http://localhost:4600/";
const CHROME =
...
const OUTPUT = path.resolve(
  ...
  process.env.UAT_REPORT_PATH ??
    "qa/reports/latest/mt2/MT2XX_v15.1_browser_UAT_postfix_20260911.json",
);
const WORKBOOK = path.join(
  ROOT,
  "qa/reports/latest/mt2/MT2xx_SSI_Resolution_UAT執行清單_v15.1.xlsx",
);
