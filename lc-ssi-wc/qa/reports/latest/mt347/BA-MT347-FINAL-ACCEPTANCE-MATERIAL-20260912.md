...
|---|---|---|
| `qa/tdd/mt347/MT347_SR2026_SSI_TDD_CONTROLLED_v5.xlsx` | `82C6ABCFD91E7D35E1382F8C86BF796D8DBF05CF8C8D94F9F0C7B5889AB52C9A` | Controlled TDD DRAFT |
...
|---|---|---|
| `qa/reports/latest/mt347/controlled-positive-uat.json` | `C9455E660FAB446C81D9BF42D7840BA5E6492937A9EC5676B16B38D7FBE5F8BA` | 152 API calls, all HTTP 200, one snapshot hash, report declares 152 passed |
| `qa/fixtures/mt347/mt347-positive.v1.json` | `F661353AF3875028CEED49502E29635DBCED28928A2140C632BAB99DA3782BDD` | 152 positive records, but 60 records have an empty `expectedTags` assertion |
| `qa/fixtures/mt347/mt347-negative.v1.json` | `D82E43CF0CF15DF2D45D65BB6CA7B49C5ED6AF702DD0A512B200C242AFE66A09` | Negative fixture exists; no executable result file supplied |
| `qa/fixtures/mt347/mt347-boundary.v1.json` | `A6213528B911905E0857B8ED230BD1E7FC5E61DCADDDE76D44D692389584C2C2` | Boundary fixture exists; no executable result file supplied |
...
No negative or boundary execution evidence was present in `qa/reports/latest/mt347/`. All 208 negative and 2 boundary cases therefore remain **NOT_EXECUTED**.
