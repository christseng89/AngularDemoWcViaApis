...
- 詳細結果：`qa/reports/latest/mt2/mt2-release-qa-run.json`、`qa/reports/latest/mt2/mt2-139-ui-results.json`、`qa/reports/latest/mt2/mt2-resolver-exhaustive-random.json`。
