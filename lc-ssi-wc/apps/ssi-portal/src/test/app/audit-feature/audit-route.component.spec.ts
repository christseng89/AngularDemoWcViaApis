...
describe("Audit lazy route view", () => {
  const featureTemplate = () =>
    readFileSync(join(join(process.cwd(), "apps/ssi-portal/src/app/audit-feature"), "audit-route.component.html"), "utf8");
  const parentTemplate = () =>
    readFileSync(join(join(process.cwd(), "apps/ssi-portal/src/app/audit-feature"), "../app.component.html"), "utf8");
  ...
  it("exposes Audit-owned refresh without calling SSI Maintenance", () => {
    const route = readFileSync(
      join(join(process.cwd(), "apps/ssi-portal/src/app/audit-feature"), "audit-route.component.ts"),
      "utf8",
    );
