...
jest.mock("../../app/governance-index-table.component", () => ({ GovernanceIndexTableComponent: class {} }));
...
describe("SettingsPageComponent", () => {
  ...
  it("loads server-authoritative runtime settings", async () => {
    const { SettingsPageComponent } = await import("../../app/settings-page.component");
