...
const ssi = readFileSync(
  join(join(process.cwd(), "apps/ssi-portal/src/app"), "ssi-maintenance-feature", "dashboard-route.component.html"),
  "utf8",
);
const sharedTs = readFileSync(
  join(join(process.cwd(), "apps/ssi-portal/src/app"), "swift-data-crud.component.ts"),
  "utf8",
);
