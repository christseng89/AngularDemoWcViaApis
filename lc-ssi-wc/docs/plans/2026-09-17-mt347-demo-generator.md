...
**Files:**
- Create: `data/qa/src/ssi/oracle-contract.ts`
- Create: `data/qa/src/ssi/oracle.repository.ts`
- Test: `data/qa/src/ssi/oracle.repository.test.ts`
...
**Files:**
- Create: `data/qa/src/ssi/mt347-demo.generator.ts`
- Test: `data/qa/src/ssi/mt347-demo.generator.test.ts`
...
**Files:**
- Create: `data/qa/src/ssi/oracle-comparator.ts`
- Test: `data/qa/src/ssi/oracle-comparator.test.ts`
...
**Files:**
- Create: `data/qa/src/ssi/dry-run.ts`
- Modify: `data/qa/src/ssi/README.md`
- Modify: `package.json`
...
3. Emit a JSON report under `data/qa/ssi/generated/` containing `databaseWrites=0`, exact reconciliation and mismatch list.
