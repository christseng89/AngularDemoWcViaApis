...
- Create: `data/qa/ssi/mt1-mt2/active-inventory.v1.json`
- Create: `data/qa/ssi/mt1-mt2/runtime-drift-preservation.v1.json`
- Create: `data/qa/src/ssi/mt1-mt2-active-inventory.ts`
- Test: `data/qa/src/ssi/mt1-mt2-active-inventory.test.ts`
...
Run: `node --experimental-strip-types --test data/qa/src/ssi/mt1-mt2-active-inventory.test.ts`
...
Run: `npx eslint data/qa/src/ssi/mt1-mt2-active-inventory.ts data/qa/src/ssi/mt1-mt2-active-inventory.test.ts`
...
- Create: `data/qa/ssi/mt1-mt2/repair-rule-table.v1.json`
- Create: `data/qa/ssi/mt1-mt2/test-oracle.v1.json`
- Create: `data/qa/ssi/mt1-mt2/ba-qa-review.v1.md`
- Create: `data/qa/ssi/mt1-mt2/rule-oracle.schema.v1.json`
- Create: `data/qa/ssi/mt1-mt2/outcome-reason-code-catalogue.v1.json`
- Create: `data/qa/ssi/mt1-mt2/schema-meta-test-vectors.v1.json`
- Create: `data/qa/ssi/mt1-mt2/expected-partition-manifest.v1.json`
- Create: `data/qa/ssi/mt1-mt2/product-policy-evidence-registry.v1.json`
- Create: `data/qa/ssi/mt1-mt2/ba-ruling-evidence-registry.v1.json`
- Create: `data/qa/ssi/mt1-mt2/qa-invariant-evidence-registry.v1.json`
- Create: `data/qa/ssi/mt1-mt2/out-of-scope-message-catalogue.v1.json`
- Create: `data/qa/ssi/mt1-mt2/execution-context-catalogues.v1.json`
- Create: `data/qa/ssi/mt1-mt2/derivation-tuple-catalogue.v1.json`
- Create: `data/qa/ssi/mt1-mt2/api-execution-contract-catalogue.v1.json`
- Create: `data/qa/ssi/mt1-mt2/expected-selected-identity-manifest.v1.json`
- Create: `data/qa/ssi/mt1-mt2/schema-approval-pack.v1.json`
- Create: `data/qa/src/ssi/mt1-mt2-rule-oracle.schema.ts`
- Create: `data/qa/src/ssi/validate-mt1-mt2-rule-table.ts`
- Test: `data/qa/src/ssi/validate-mt1-mt2-rule-table.test.ts`
...
Run: `node --experimental-strip-types --test data/qa/src/ssi/validate-mt1-mt2-rule-table.test.ts`

Run: `node --experimental-strip-types data/qa/src/ssi/validate-mt1-mt2-rule-table.ts --rules data/qa/ssi/mt1-mt2/repair-rule-table.v1.json --oracle data/qa/ssi/mt1-mt2/test-oracle.v1.json --out data/qa/ssi/mt1-mt2/rule-table-validation.v1.json`
...
- Create: `data/qa/src/message-version-policy.ts`
- Create: `data/qa/src/versioned-record-identity.ts`
- Create: `data/qa/src/dataset-visibility-policy.ts`
- Create: `data/qa/src/ssi/mt1-mt2-repair-planner.ts`
...
Run: `node --experimental-strip-types --test data/qa/src/message-version-policy.test.ts data/qa/src/versioned-record-identity.test.ts data/qa/src/dataset-visibility-policy.test.ts data/qa/src/ssi/mt1-mt2-repair-planner.test.ts`
...
- Create: `data/qa/src/ssi/mt1-mt2-demo.generator.ts`
- Create: `data/qa/src/ssi/mt1-mt2-canonical-seed.mapper.ts`
- Test: corresponding `*.test.ts`
- Output: `data/qa/ssi/mt1-mt2/generated/`
...
Run: `node --experimental-strip-types data/qa/src/ssi/mt1-mt2-demo.generator.ts --rules data/qa/ssi/mt1-mt2/repair-rule-table.v1.json --oracle data/qa/ssi/mt1-mt2/test-oracle.v1.json --out data/qa/ssi/mt1-mt2/generated/ssi-demo.mt1-mt2-pacs008-pacs009.sr2026.v1.candidate.json`

Run: `node --experimental-strip-types --test data/qa/src/ssi/mt1-mt2-demo.generator.test.ts data/qa/src/ssi/mt1-mt2-canonical-seed.mapper.test.ts`
...
- Create: `data/qa/src/ssi/prepare-mt1-mt2-reload-source.ts`
- Test: `data/qa/src/ssi/prepare-mt1-mt2-reload-source.test.ts`
- Create: `data/qa/ssi/reload-test-data/ssi-demo.mt1-mt2.v1.candidate.canonical.seed.json`
- Create: `data/qa/ssi/mt1-mt2/generated/candidate-seed-manifest.v1.json`

**Step 1: Write the failing complete-seed tests**

Run: `node --experimental-strip-types --test data/qa/src/ssi/prepare-mt1-mt2-reload-source.test.ts`
...
Run: `node --experimental-strip-types data/qa/src/ssi/prepare-mt1-mt2-reload-source.ts --mode build-candidate --base-configured-seed data/qa/ssi/reload-test-data/ssi-demo.mt347-v1.1.approved.canonical.seed.json --generated-overlay data/qa/ssi/mt1-mt2/generated/ssi-demo.mt1-mt2-pacs008-pacs009.sr2026.v1.candidate.json --preserve-runtime-rows data/qa/ssi/mt1-mt2/runtime-drift-preservation.v1.json --candidate data/qa/ssi/reload-test-data/ssi-demo.mt1-mt2.v1.candidate.canonical.seed.json --manifest data/qa/ssi/mt1-mt2/generated/candidate-seed-manifest.v1.json`
...
- Create: `data/qa/src/ssi/mt1-mt2-api-dry-run.ts`
- Test: `data/qa/src/ssi/mt1-mt2-api-dry-run.test.ts`
- Ephemeral DB: `data/qa/ssi/mt1-mt2/generated/api-dry-run.isolated.sqlite`
- Input: `data/qa/ssi/mt1-mt2/api-execution-contract-catalogue.v1.json`
- Output: `data/qa/ssi/mt1-mt2/generated/api-dry-run.v1.json`
...
Run: `node --experimental-strip-types data/qa/src/ssi/mt1-mt2-api-dry-run.ts --mode candidate-backed-isolated --candidate-seed data/qa/ssi/reload-test-data/ssi-demo.mt1-mt2.v1.candidate.canonical.seed.json --manifest data/qa/ssi/mt1-mt2/generated/candidate-seed-manifest.v1.json --oracle data/qa/ssi/mt1-mt2/test-oracle.v1.json --api-contract-catalogue data/qa/ssi/mt1-mt2/api-execution-contract-catalogue.v1.json --isolated-db data/qa/ssi/mt1-mt2/generated/api-dry-run.isolated.sqlite --service-project ssi-service --service-port 3310 --base-url http://127.0.0.1:3310/api --out data/qa/ssi/mt1-mt2/generated/api-dry-run.v1.json`

Run: `node --experimental-strip-types --test data/qa/src/ssi/mt1-mt2-api-dry-run.test.ts`
...
- Create: `data/qa/src/ssi/mt1-mt2-reload-preflight.ts`
- Test: `data/qa/src/ssi/mt1-mt2-reload-preflight.test.ts`
- Output: `data/qa/ssi/mt1-mt2/generated/reload-preflight.v1.json`

**Step 1: Build an isolated DB from the frozen complete candidate seed**

No runtime DB access is allowed in this step.

Run: `node --experimental-strip-types data/qa/src/ssi/mt1-mt2-reload-preflight.ts --source data/qa/ssi/reload-test-data/ssi-demo.mt1-mt2.v1.candidate.canonical.seed.json --manifest data/qa/ssi/mt1-mt2/generated/candidate-seed-manifest.v1.json --mode plan-only --out data/qa/ssi/mt1-mt2/generated/reload-preflight.v1.json`

Expected: exit `0`; no runtime DB access and no DB write.

**Step 2: Apply the candidate twice**

Run: `node --experimental-strip-types --test data/qa/src/ssi/mt1-mt2-reload-preflight.test.ts`
...
- Create: `data/qa/ssi/mt1-mt2/generated/dba-preflight.v1.json`
- Create: `data/qa/src/ssi/mt1-mt2-dba-preflight.ts`
- Test: `data/qa/src/ssi/mt1-mt2-dba-preflight.test.ts`

**Step 1: Run DB-side query-plan and latency tests on the identical isolated snapshot**

Run: `node --experimental-strip-types --test data/qa/src/ssi/mt1-mt2-dba-preflight.test.ts`
...
Run: `node --experimental-strip-types data/qa/src/ssi/mt1-mt2-dba-preflight.ts --preflight data/qa/ssi/mt1-mt2/generated/reload-preflight.v1.json --out data/qa/ssi/mt1-mt2/generated/dba-preflight.v1.json`
...
- Input: `data/qa/ssi/reload-test-data/ssi-demo.mt1-mt2.v1.candidate.canonical.seed.json`
- Input: `data/qa/ssi/mt1-mt2/generated/candidate-seed-manifest.v1.json`
- Publish after Gate 4A only: `data/qa/ssi/reload-test-data/ssi-demo.mt1-mt2.v1.approved.canonical.seed.json`
- Use: `data/qa/src/ssi/prepare-mt1-mt2-reload-source.ts`
- Test: `data/qa/src/ssi/prepare-mt1-mt2-reload-source.test.ts`
- Modify: `.env.example`
...
Run only after recorded Gate 4A approval: `node --experimental-strip-types data/qa/src/ssi/prepare-mt1-mt2-reload-source.ts --candidate data/qa/ssi/reload-test-data/ssi-demo.mt1-mt2.v1.candidate.canonical.seed.json --authorization data/qa/ssi/mt1-mt2/gate-4a-authorization.v1.json --publish data/qa/ssi/reload-test-data/ssi-demo.mt1-mt2.v1.approved.canonical.seed.json`
...
- Create: `data/qa/src/ssi/mt1-mt2-runtime-apply.ts`
- Test: `data/qa/src/ssi/mt1-mt2-runtime-apply.test.ts`
- Output: `data/qa/ssi/mt1-mt2/generated/runtime-apply.v1.json`
- Backup: `data/qa/ssi/mt1-mt2/generated/backup/runtime-before-<logical-sha>.sqlite`
- Restore drill output: `data/qa/ssi/mt1-mt2/generated/backup/restore-drill.v1.json`
...
Run only after recorded Gate 4B approval: `node --experimental-strip-types data/qa/src/ssi/mt1-mt2-runtime-apply.ts --mode isolated-reload --seed data/qa/ssi/reload-test-data/ssi-demo.mt1-mt2.v1.approved.canonical.seed.json --authorization data/qa/ssi/mt1-mt2/gate-4b-authorization.v1.json --service apps/ssi-service/src/app/development-data-reload.service.ts --out data/qa/ssi/mt1-mt2/generated/isolated-reload.v1.json`
...
Run before requesting Gate 4C: `node --experimental-strip-types data/qa/src/ssi/mt1-mt2-runtime-apply.ts --mode backup-verify --runtime-db ./data/ssi-demo.sqlite --expected-runtime-sha <GATE_4C_BEFORE_SHA> --backup-dir data/qa/ssi/mt1-mt2/generated/backup --out data/qa/ssi/mt1-mt2/generated/backup/backup-verify.v1.json`

Run: `node --experimental-strip-types data/qa/src/ssi/mt1-mt2-runtime-apply.ts --mode restore-drill --backup-manifest data/qa/ssi/mt1-mt2/generated/backup/backup-verify.v1.json --restore-target data/qa/ssi/mt1-mt2/generated/backup/restore-drill.sqlite --out data/qa/ssi/mt1-mt2/generated/backup/restore-drill.v1.json`
...
2. Run `node --experimental-strip-types data/qa/src/ssi/mt1-mt2-runtime-apply.ts --mode assert-quiesced --runtime-db ./data/ssi-demo.sqlite --ports 3000,3100,4600 --out data/qa/ssi/mt1-mt2/generated/backup/quiesce.v1.json`.
3. Run `node --experimental-strip-types data/qa/src/ssi/mt1-mt2-runtime-apply.ts --mode runtime-restore --runtime-db ./data/ssi-demo.sqlite --quiesce-evidence data/qa/ssi/mt1-mt2/generated/backup/quiesce.v1.json --backup-manifest data/qa/ssi/mt1-mt2/generated/backup/backup-verify.v1.json --authorization data/qa/ssi/mt1-mt2/gate-4c-authorization.v1.json --expected-restored-sha <GATE_4C_BEFORE_SHA> --out data/qa/ssi/mt1-mt2/generated/backup/runtime-restore.v1.json`.
...
Run only after recorded Gate 4C approval: `node --experimental-strip-types data/qa/src/ssi/mt1-mt2-runtime-apply.ts --mode development-runtime-apply --endpoint http://localhost:3100/api/settings/development-data/reload --seed data/qa/ssi/reload-test-data/ssi-demo.mt1-mt2.v1.approved.canonical.seed.json --authorization data/qa/ssi/mt1-mt2/gate-4c-authorization.v1.json --out data/qa/ssi/mt1-mt2/generated/runtime-apply.v1.json`
...
- Create: `data/qa/ssi/mt1-mt2/ui-acceptance.v1.json`
- Create: `data/qa/ssi/mt1-mt2/final-reconciliation.v1.md`
- Create: `data/qa/src/ssi/mt1-mt2-browser-uat.ts`
- Test: `data/qa/src/ssi/mt1-mt2-ui-reload.test.ts`
...
Run: `node --experimental-strip-types data/qa/src/ssi/mt1-mt2-browser-uat.ts --base-url http://localhost:4600 --rules data/qa/ssi/mt1-mt2/repair-rule-table.v1.json --oracle data/qa/ssi/mt1-mt2/test-oracle.v1.json --out data/qa/ssi/mt1-mt2/ui-acceptance.v1.json`
...
Run only after Gate 4C for Development Runtime UI: `node --experimental-strip-types --test data/qa/src/ssi/mt1-mt2-ui-reload.test.ts`
...
Run: `rg -n "pacs\\.00[89]\\.001\\.(12|012)|\.001\.08|ACTIVE|DRAFT|approved\.canonical" data/qa/src data/qa/ssi apps/ssi-service apps/ssi-portal`
