...
**Files:**
- Create: `scripts/governed-data-repair/domain.ts`
- Test: `scripts/governed-data-repair/domain.test.ts`
...
**Files:**
- Create: `scripts/governed-data-repair/planner.ts`
- Test: `scripts/governed-data-repair/planner.test.ts`
...
**Files:**
- Create: `scripts/governed-data-repair/api-snapshot.repository.ts`
- Create: `scripts/governed-data-repair/json-report.writer.ts`
- Create: `scripts/governed-data-repair/cli.ts`
- Modify: `package.json`
