...
**Files:**
- Create: `qa/FIX_DATA/governed-data-repair/domain.ts`
- Test: `qa/FIX_DATA/governed-data-repair/domain.test.ts`
...
**Files:**
- Create: `qa/FIX_DATA/governed-data-repair/planner.ts`
- Test: `qa/FIX_DATA/governed-data-repair/planner.test.ts`
...
**Files:**
- Create: `qa/FIX_DATA/governed-data-repair/api-snapshot.repository.ts`
- Create: `qa/FIX_DATA/governed-data-repair/json-report.writer.ts`
- Create: `qa/FIX_DATA/governed-data-repair/cli.ts`
- Modify: `package.json`
