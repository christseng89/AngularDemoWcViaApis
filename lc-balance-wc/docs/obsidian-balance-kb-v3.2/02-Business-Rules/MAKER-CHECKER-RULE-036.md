...
## 业务规则
对于 A3S/SG、B3-Honour 应收款、B4-Usance-ACCEPT，以及 B5-SETTLE 这几种复合提交，deleteMakerPending() 会先撤销最晚建立的关联分腿，最后才撤销最初提交的主 movement，因此经办人的撤销动作永远不会让较晚建立的分腿以孤立 PENDING 状态遗留。
