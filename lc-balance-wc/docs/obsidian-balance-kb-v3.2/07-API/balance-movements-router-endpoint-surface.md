...
> [!info] 2026-08-30 更新
> 本页原先的 8 端点清单是历史快照。现行微服务 OAS v1.42.0 包含 compound submit/release、edit、cancel 与 withdraw-maker-submit；本次仅补充生命周期与 inquiry error response 语义，没有新增 operation。完整表面以 `analysis/balance-component-api.yaml` 为准。
